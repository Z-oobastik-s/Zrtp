...
- **Minecraft**: 1.17 или выше
- **Spigot/Paper**: Последняя стабильная версия
- **Java**: Java 16 или выше
...
Если у вас возникли проблемы с плагином или вы нашли ошибку, пожалуйста, создайте [Issue на GitHub](https://github.com/Z-oobastik-s/Zrtp/issues).
